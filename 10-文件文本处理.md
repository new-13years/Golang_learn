...
Go语言通过regexp标准包为正则表达式提供了官方支持，如果你已经使用过其他编程语言提供的正则相关功能，那么你应该对Go语言版本的不会太陌生，但是它们之间也有一些小的差异，因为Go实现的是RE2标准，除了\C，详细的语法描述参考：[http://code.google.com/p/re2/wiki/Syntax](http://code.google.com/p/re2/wiki/Syntax)
...
![[attachments/Pasted image 20251229180021.png]]
...
```
![[attachments/Pasted image 20251229185802.png]]
##### struct tag
![[attachments/Pasted image 20251229185127.png]]
...
```
![[attachments/Pasted image 20251230090720.png]]
...
![[attachments/Pasted image 20251230093802.png]]
...
![[attachments/Pasted image 20251230094910.png]]
...
```
![[attachments/Pasted image 20251230100330.png]]
xxx.txt内容如下：
![[attachments/Pasted image 20251230100318.png]]
#### 读文件
...
```
![[attachments/Pasted image 20251230103059.png]]

![[attachments/Pasted image 20251230103135.png]]