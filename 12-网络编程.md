...
![[attachments/Pasted image 20251230155702.png]]
...
![[attachments/Pasted image 20251230160231.png]]

#### 每层协议的功能
![[attachments/Pasted image 20251230160257.png]]
...
### TCP的C/S架构
![[attachments/Pasted image 20251230161544.png]]
...
#### 运行结果
![[attachments/Pasted image 20251230162654.png]]
...
![[attachments/Pasted image 20251230162757.png]]
...
![[attachments/Pasted image 20251230162906.png]]

#### 地址（URL）
**Uniform Resource Locator**，中文标准译名是**统一资源定位符**

>  ***==URL== Uniform Resource Locator*** → 统一资源定位符作用：给资源**定位置**，比如`https://www.baidu.com/s?wd=golang`，告诉你资源在哪、怎么访问
>  ***==URI== Uniform Resource Identifier*** → 统一资源标识符作用：给资源**起名字 / 做标识**，范围比 URL 大，URL 是 URI 的子集
>  ***==URN== Uniform Resource Name*** → 统一资源名称作用：给资源**起唯一名字**，不关心位置，比如`urn:isbn:9787111672942`（图书 ISBN）
...
```
浏览器输入url地址：
![[attachments/Pasted image 20251230163722.png]]
服务器端运行打印结果如下：
![[attachments/Pasted image 20251230163705.png]]
![[attachments/Pasted image 20251230163739.png]]
##### 请求报文格式说明
HTTP 请求报文由请求行、请求头部、空行、请求包体4个部分组成，如下图所示：
![[attachments/Pasted image 20251230163801.png]]
...
2. 请求头部
		...
		![[attachments/Pasted image 20251230164232.png]]
3. 空行
...
启动服务器程序：
![[attachments/Pasted image 20251230164533.png]]客户端测试示例代码：
...
```
启动程序，测试http的成功响应报文：
![[attachments/Pasted image 20251230164836.png]]
![[attachments/Pasted image 20251230164847.png]]

启动程序，测试http的失败响应报文：
![[attachments/Pasted image 20251230164901.png]]

##### 响应报文格式说明:
HTTP 响应报文由状态行、响应头部、空行、响应包体4个部分组成，如下图所示：
![[attachments/Pasted image 20251230164944.png]]
...
浏览器输入url地址：
![[attachments/Pasted image 20251230165621.png]]

服务器运行结果：
![[attachments/Pasted image 20251230165634.png]]
...
![[attachments/Pasted image 20251230165828.png]]